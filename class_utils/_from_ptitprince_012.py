# This code is adapted from the PtitPrince package, which can be found at
# https://github.com/pog87/PtitPrince; it is licensed under the MIT license.

# this is a version patched to work with seaborn >=0.12
...
from seaborn.categorical import _CategoricalPlotter, stripplot
